...
cd server/bin
java -cp .:../lib/cameraproxy.jar:../lib/media.jar se/axisandandroids/server/CameraServer 6004 -camera argus-8.student.lth.se 4321 &
java -cp .:../lib/cameraproxy.jar:../lib/media.jar se/axisandandroids/server/CameraServer 6006 -camera argus-8.student.lth.se 4444 &
